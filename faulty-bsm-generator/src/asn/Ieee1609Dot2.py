...
class IEEE1609dot2BaseTypes:
    ...
    #-----< Elevation >-----#
    Elevation = INT(name='Elevation', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2BaseTypes', 'ElevInt')))
    ...
    #-----< ElevInt >-----#
    ElevInt = INT(name='ElevInt', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2BaseTypes', 'Uint16')))
...
class IEEE1609dot2:
    ...
    _name_  = 'IEEE1609dot2'
    _oid_   = [1, 3, 111, 2, 1609, 2, 1, 1, 2]
    
    _obj_ = [
        'SignedDataPayload',
        'TestIeee1609Dot2Data',
        'Ieee1609Dot2Data',
        'Ieee1609Dot2Content',
        'SignedData',
        'SignerIdentifier',
    ...
    #-----< TestIeee1609Dot2Data >-----#
    TestIeee1609Dot2Data = SEQ(name='TestIeee1609Dot2Data', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2', 'Ieee1609Dot2Data')))
    ...
    _HeaderInfo_flags = BIT_STR(name='flags', mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT), typeref=ASN1RefType(('IEEE1609dot2', 'HeaderInfoFlags')), opt=True)
    HeaderInfo._cont = ASN1Dict([
        ...
        ('flags', _HeaderInfo_flags),
        ])
    HeaderInfo._ext = ['inlineP2pcdRequest', 'requestedCertificate', 'flags']
    
    #-----< TestHeaderInfo >-----#
    TestHeaderInfo = SEQ(name='TestHeaderInfo', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2', 'HeaderInfo')))
    
    #-----< HeaderInfoFlags >-----#
    HeaderInfoFlags = BIT_STR(name='HeaderInfoFlags', mode=MODE_TYPE)
    HeaderInfoFlags._cont = ASN1Dict([('iso21177ExtendedAuth', 0)])
    HeaderInfoFlags._const_sz = ASN1Set(rv=[8], rr=[], ev=None, er=[])
    ...
    #-----< TestCracaId >-----#
    TestCracaId = OCT_STR(name='TestCracaId', mode=MODE_TYPE)
    TestCracaId._const_sz = ASN1Set(rv=[3], rr=[], ev=None, er=[])
    
    #-----< TestCracaIdSubtype >-----#
    TestCracaIdSubtype = OCT_STR(name='TestCracaIdSubtype', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2', 'TestCracaId')))
    TestCracaIdSubtype._const_val = ASN1Set(rv=[b'\x00\x00\x00', b'\x11\x11\x11'], rr=[], ev=None, er=[])
    ...
    #-----< TestCertificate >-----#
    TestCertificate = SEQ(name='TestCertificate', mode=MODE_TYPE, typeref=ASN1RefType(('IEEE1609dot2', 'Certificate')))
    ...
    EndEntityType._cont = ASN1Dict([('app', 0), ('enrol', 1)])
...
init_modules(IEEE1609dot2BaseTypes, IEEE1609dot2)